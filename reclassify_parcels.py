...
def main():
    ...
    COMMERCIAL_KEYWORDS = [
        ...
        # Arabic - Hotels/Studios/Rentals
        'شيراتون', 'هيلتون', 'ماريوت', 'موفنبيك', 'نوفوتيل', 'راديسون', 'كراون',
        'استديو', 'استوديو', 'إستديو', 'إستوديو', 'انتاج', 'إنتاج',
        'تأجير', 'تاجير', 'ايجار', 'إيجار',
        # English
    ...
    SERVICE_KEYWORDS = [
        ...
        'معاشات', 'تقاعد', 'تأمينات', 'مصلحة', 'هيئة', 'مركز',
